...
import com.rarasnet.rnp.desordens.search.controllers.activities.Professionals;
...
public class DisorderSignsFragment extends Fragment {
   ...
   // List<Professionals>
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new SignsAdapter(getDisorderSigns());
        qnt.setText(String.valueOf(getDisorderSigns().size()));
