package com.rarasnet.rnp.documentos.adapters;
 ...
 */
public class ProtocoloAdapter extends RecyclerView.Adapter<ProtocoloAdapter.MyViewHolder> {
    private List<Protocolo> mList;
    private LayoutInflater mLayoutInflater;
    private RecyclerViewOnClickListenerHack mRecyclerViewOnClickListenerHack;


    public ProtocoloAdapter(Context c, List<Protocolo> l){
        mList = l;
    ...
    public void addListItem(Protocolo c, int position){
        mList.add(c);
