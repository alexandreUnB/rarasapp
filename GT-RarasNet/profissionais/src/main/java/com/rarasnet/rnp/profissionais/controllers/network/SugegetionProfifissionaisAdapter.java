package com.rarasnet.rnp.profissionais.controllers.network;
 ...
 */
public class SugegetionProfifissionaisAdapter {

    //private String searchURL = "http://192.168.56.2/webservice/rest_profissionais.json";

    public SearchProfissionaisDataResponse[] searchProf(String userInput, String searchOption) throws Exception {
        ...
        SearchProfissionaisDataResponse[] searchProfissionaisDataResponses = null;
        ...
        searchProfissionaisDataResponses = requester.getResponse(SearchProfissionaisDataResponse[].class);


        return searchProfissionaisDataResponses;
    }
